(function (global, factory) {
  ...
  _exports.renderToStringWithData = _exports.getMarkupFromTree = _exports.getDataFromTree = _exports.resetApolloContext = _exports.getApolloContext = _exports.ApolloProvider = void 0;
  ...
  _exports.getDataFromTree = _reactComponents.getDataFromTree;
  _exports.getMarkupFromTree = _reactComponents.getMarkupFromTree;
  _exports.renderToStringWithData = _reactComponents.renderToStringWithData;
    ...
    return function (WrappedComponent) {
      ...
      var GraphQL = function (_super) {
        ...
        GraphQL.prototype.render = function () {
          ...
          return _react.default.createElement(_reactComponents.Mutation, (0, _tslib.__assign)({}, opts, {
            mutation: document,
            ignoreResults: true
          }), function (mutate, _a) {
            var _b, _c;
