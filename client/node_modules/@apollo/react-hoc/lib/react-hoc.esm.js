...
export { getDataFromTree, getMarkupFromTree, renderToStringWithData } from '@apollo/react-components';
    ...
    return function (WrappedComponent) {
        ...
        var GraphQL = (function (_super) {
            ...
            GraphQL.prototype.render = function () {
                ...
                return (React.createElement(Mutation, __assign({}, opts, { mutation: document, ignoreResults: true }), function (mutate, _a) {
                    var _b, _c;
