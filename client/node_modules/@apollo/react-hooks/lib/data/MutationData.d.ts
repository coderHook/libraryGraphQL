...
export declare class MutationData<TData = any, TVariables = OperationVariables> extends OperationData {
    ...
    execute(result: MutationResult<TData>): [(options?: MutationFunctionOptions<TData, TVariables> | undefined) => Promise<void | ExecutionResult<TData>>, MutationResult<TData>];
    afterExecute(): () => void;
